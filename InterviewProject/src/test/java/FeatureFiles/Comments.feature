...
Scenario: Post 200
    ...
    When the "POST200Comments.txt" scenario file is loaded
    Then the "POST" request is sent and the response passes assertions

Scenario: Get 200
    Given the Method is "POST" for the endpoint "users"
    When the "POSTDefaultComments.txt" scenario file is loaded
    And request is sent
...
Scenario: Put 200
    ...
    And the PUT file is set to "PUT200Comments.txt"
